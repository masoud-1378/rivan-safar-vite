...
export const SAMPLE_TOURS: TourItem[] = [
  {
    ...
    description: 'تور استانبول با پرواز مستقیم ماهان ایر و پشتیبانی ۲۴ ساعته لیدر فارسی‌زبان. اقامت در بهترین هتل‌های منطقه تکسیم و شیشلی با دسترسی عالی به مراکز خرید.'
  },
  {
    id: 'antalya-summer',
    ...
    description: 'تجربه رؤیایی در سواحل مدیترانه آنتالیا با خدمات کامل غذا و نوشیدنی ۲۴ ساعته، استخرهای اختصاصی، پارک آبی و برنامه شبانه.'
  },
  {
    id: 'dubai-autumn',
    ...
    badge: 'ویزای فوری',
    features: ['ویزای ۲۴ ساعته امارات', 'هتل‌های نزدیک دبی مال'],
    visaRequired: true,
    hotelStars: 4,
    airline: 'ماهان',
  ...
  },
  {
    ...
    description: 'ترکیب مدرنیته و طبیعت بکر مالزی؛ ۴ شب در کوالالامپور و ۳ شب در سواحل رؤیایی جزیره لنکاوی.'
  }
];
...
export const TOUR_FAQ_ITEMS = [
  ...
  {
    q: 'آیا امکان رزرو تلفنی تور وجود دارد؟',
    a: 'بله، شما می‌توانید علاوه بر ثبت درخواست آنلاین در سایت، از طریق تماس تلفنی با شماره ۰۲۶-۳۳۳۵۰۱۳۹ مستقیماً با کارشناسان تور مشورت کرده و تور خود را تلفنی رزرو کنید.'
  },
  {
...
export const RELATED_GUIDE_ARTICLES = [
  ...
  },
  {
    ...
    title: 'پیش از رزرو تور خارجی چه مدارکی آماده کنیم؟',
