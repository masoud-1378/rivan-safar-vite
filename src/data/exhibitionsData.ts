...
export const EXHIBITION_SERIES: Record<string, ExhibitionSeries> = {
  ...
  'gulfood': {
    ...
    businessTips: [
      'به دلیل ازدحام شدید اطراف DWTC، اقامت در هتل‌های متصل به خط قرمز مترو بیشترین صرفه‌جویی در زمان را به همراه دارد.'
    ],
    faqs: [
      {
        question: 'آیا هماهنگی بلیت ورودی گلفود از طریق ریوان سفر انجام می‌شود؟',
