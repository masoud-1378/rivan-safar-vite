...
export const CITIES: Record<string, Place> = {
  ...
  mashhad: {
    ...
    keyHighlights: ['هتل‌های پیاده‌رو تا حرم', 'امکان انتخاب هتل با صبحانه، ناهار و شام (فولبرد)', 'پکیج‌های متنوع ریلی و هوایی'],
    ...
    faqs: [
      {
        ...
        answer: 'بسته به هتل انتخابی، می‌توانید اقامت را با صبحانه (BB) یا به‌صورت فولبرد (صبحانه، ناهار و شام) هماهنگ کنید.'
      }
    ],
