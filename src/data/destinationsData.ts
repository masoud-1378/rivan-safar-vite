...
export const CITIES: Record<string, Place> = {
  ...
  antalya: {
    ...
    keyHighlights: ['ریزورت‌های ساحلی با تمام وعده‌های غذایی و نوشیدنی ۲۴ ساعته', 'پارک‌های آبی و کلوب‌های کودکان', 'پرواز مستقیم به فرودگاه آنتالیا'],
    travelTips: [
  ...
  phuket: {
    ...
    description: 'پوکت نگین سواحل جنوب تایلند با آب‌های شفاف دریای آندامان، جزیره فی‌فی، خلیج مایا و ریزورت‌های ساحلی رویایی است.',
    bestSeason: 'آبان تا فروردین',
    visaRequired: true,
